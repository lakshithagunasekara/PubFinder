...
def load_search_results(sources, sources_directory, output_directory):
    ...
    journal_data_df.to_csv(f'{output_directory}/1_combined_initial_search_results.csv', index=False)
    log.info(f"Appended file saved to {output_directory}/1_combined_initial_search_results.csv")
